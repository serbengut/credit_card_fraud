...
# vble. 1
distance_from_home = st.slider('Distancia desde casa en km', 0, 1000)
...
# vble. 3
ratio_to_median_purchase_price = st.slider('Ratio entre valor de la compra y el valor de la mediana de las compras anteriores', 0, 100)
